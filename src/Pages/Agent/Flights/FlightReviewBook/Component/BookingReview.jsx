...
//import Moment from 'moment';
export default function BookingReview({listOfFlight,fareDetail,reInitialValues}) {
                                   ...
                                   <tbody>
                                      {
                                        listOfTravellerInfo.map((flightValue, flightKey) => (
                                          <tr>
                                            ...
                                            <td>
                                            <div className='graysmalltext'><i class="fa-solid fa-suitcase me-1"></i>{flightValue.flightWithBaggae}</div>
                                            <div className='graysmalltext'><i class="fa-solid fa-utensils"></i> {flightValue.flighWithMeal}</div>
                                            </td>
                                          </tr>
                                        ))
                                      }
