                                                    ...
                                                    <div className='row'>
                                                        <div className='col-6'>
                                                            ...
                                                            <div className='row mt-3'>
                                                                ...
                                                                <div className="col-6 text-center text-danger fw-normal h6 small"> Seats left: <span id="seatleft5310">{value?.fareDetail?.seatRemains}</span> </div>
                                                            </div>
                                                        </div>
                            ...
                            <div className='d-flex'>
                                ...
                                <div className=''>
                                    ...
                                    <div className="flightnumber" id="">
                                        <span> 6E-6114 </span><br/> <span>( 22:55, 2 January 2024 -  01:10, 3 January 2024)</span> 
