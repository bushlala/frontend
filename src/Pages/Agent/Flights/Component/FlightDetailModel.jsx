  ...
  useEffect(() => {
    if (viewListOfFlight && Array.isArray(viewListOfFlight)) {
      ...
      viewListOfFlight.forEach(item => {
        if (item.arrivalAirportInformation && item.departureAirportInformation) {
          combineArray.push(item.arrivalAirportInformation.code, item.departureAirportInformation.code);
        }
      });
                        ...
                        <div className="d-flex">
                          <img
                            className="flight-flag"
                             src={listOfFlight  ? listOfFlight[0]?.flightLogo :viewListOfFlight ?viewListOfFlight[0]?.flightLogo:""}
                            alt=""
                          />
                          <div className="">
                      ...
                      <tbody>
                        <tr>
                          <td className="text-center">
                            {currency} {searchRule.CANCELLATION.DEFAULT.amount}
                          </td>
                        </tr>
                      </tbody>
                    </table>
