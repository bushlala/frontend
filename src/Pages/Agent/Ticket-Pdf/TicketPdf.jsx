    ...
    <div className='container'>
      ...
      <i className="fa-solid fa-arrow-left"  ></i> Back </button>
        <div className="col-8 m-auto mt-3">
          ...
          <div className='card ticketpdf' ref={targetRef}>
            ...
            <div className=' p-2'>
              <p className='mb-2'>- You should carry a print-out of your booking and present for check-in.</p>
              <p className='mb-2'>- Date & Time is calculated based on the local time of city/destination.</p>
              <p className='mb-2'>- Use the Reference Number for all Correspondence with us.</p>
              <p className='mb-2'>- Use the Airline PNR for all Correspondence directly with the Airline</p>
              <p className='mb-2'>- For departure terminal please check with airline first.</p>
            </div>
          </div>
