...
export default function CountryList() {
    const columns = [
        { id: 'name', label: 'Country Name', minWidth: 170, sortable: true },
        { id: 'sortName', label: 'Country Sort Name', minWidth: 100, sortable: true },
    ...
    const userDelete = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await CountryAPI.delete(id).then((response) => {
                    getListData(request);
                })
                .catch((e) => {
                    console.log(e);
                            ...
                            <div className='row'>
                                ...
                                <div className='col-6'>
                                    <Box sx={{ '& > :not(style)': { float: "right" } }}>
                                        ...
                                        >
                                            <Link to='/admin/country/add' style={{ color: 'white'}}>+ Add {formTitle}</Link>
                                        </Button>
                                    </Box>
                                </div>
                            </div>
